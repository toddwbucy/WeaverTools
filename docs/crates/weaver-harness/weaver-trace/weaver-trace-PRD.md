...
**Revised:** 2026-09-04, fourth of this date, the load names its declaration. Section
3.1's `load` event gains the declaration's digest as the enter carried it. Per issue
#435.
