...
**Status:** MERGED, and RATIFIED 2026-08-04 with the set. Cut 2026-08-01, third of the
Spec pass and the last of the floor's build order. Code is written against it under the
