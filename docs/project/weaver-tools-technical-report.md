...
claim. **Standing outside the repository makes this the one numbered section whose
own sources a reader holding the tree cannot reach**, which is said here rather
than left to be noticed. Section 13 is the narrower case and not a second of
these: its own claims are checkable and one citation it makes is not, the clock
argument sitting on an open pull request. Appendix B carries all three, appendix C
being uncheckable on a third ground.
